                ...
                <div class="row">
                    <div class="col px-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" id="exampleFormControlInput1" placeholder="horas">
                        </div>
                        <div>
                            <label for="exampleFormControlInput1" class="form-label">Precio total</label>
                            <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1" placeholder="Precio total del paquete" disabled>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
